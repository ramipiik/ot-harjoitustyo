...
from services.content_services import buy, next_period, sell, get_content
...
class TestContent(unittest.TestCase):
    ...
    def test_portfolio_content(self):
        ...
        content_object:Content=get_content(self.test_user, self.portfolio_id)
        self.assertTrue(1 in content_object.cryptos.keys())
        self.assertTrue(2 in content_object.cryptos.keys())
