...
def get_portfolio_statistics(portfolio_id):
    ...
    stats["today"]=today
    try:
        stats["d"]=round(100*(today-portfolio_history[-1-1])/portfolio_history[-1-1],2)
    except:
        stats["d"]='--'
    try:
        stats["w"]=round(100*(today-portfolio_history[-1-7])/portfolio_history[-1-7],2)
    except:
        stats["w"]='--'
    try:
        stats["m"]=round(100*(today-portfolio_history[-1-30])/portfolio_history[-1-30],2)
    except:
        stats["m"]='--'
    try:
        stats["y"]=round(100*(today-portfolio_history[-1-365])/portfolio_history[-1-365],2)
    except:
        stats["y"]='--'
    try:
