...
class LoginView:
    ...
    def _initialize(self):
        ...
        self._error_label1 = ttk.Label(
            master=self._frame, textvariable=self._error_var1
        )
        self._error_label1.grid(
            row=5,
            column=0,
        ...
        self._error_label2 = ttk.Label(
            master=self._frame, textvariable=self._error_var2
        )
        self._error_label2.grid(
            row=5,
            column=2,
            sticky=(constants.W, constants.E),
            padx=(50, 5),
        ...
        heading1_label = ttk.Label(
            master=self._frame, text="Kirjaudu", font=("Arial", 20)
        )
        heading1_label.grid(
            row=0, column=0, padx=5, pady=10, sticky=(constants.W), columnspan=2
        )
        ...
        self.username_entry1.grid(
            row=1, column=1, sticky=(constants.W, constants.E), padx=5, pady=5
        )
        ...
        self.password_entry1.grid(
            row=2, column=1, sticky=(constants.W, constants.E), padx=5, pady=5
        )

        login_button = ttk.Button(
            master=self._frame, text="Kirjaudu", command=self._handle_login_click
        )
        login_button.grid(
            row=4,
            column=0,
        ...
        heading2_label = ttk.Label(
            master=self._frame, text="Luo uusi käyttäjä", font=("Arial", 20)
        )
        heading2_label.grid(
            row=0, column=2, padx=(50, 5), pady=10, sticky=(constants.W), columnspan=2
        )

        username_label2 = ttk.Label(master=self._frame, text="Käyttäjänimi")
        username_label2.grid(
            row=1, column=2, padx=(50, 5), pady=5, sticky=(constants.W)
        )

        self.username_entry2 = ttk.Entry(master=self._frame)
        self.username_entry2.grid(
            row=1, column=3, sticky=(constants.W, constants.E), padx=5, pady=5
        )

        password_label2 = ttk.Label(master=self._frame, text="Salasana")
        password_label2.grid(
            row=2, column=2, padx=(50, 5), pady=5, sticky=(constants.W)
        )
        ...
        self.password_entry3.grid(
            row=3, column=3, sticky=(constants.W, constants.E), padx=5, pady=5
        )

        signup_button = ttk.Button(
            master=self._frame, text="Luo käyttäjä", command=self._handle_signup_click
        )
        signup_button.grid(
            row=4,
            column=2,
        ...
        switch_button = ttk.Button(
            master=self._frame, text="To test page", command=self._show_hello_view
        )
        switch_button.grid(
            row=6,
            column=0,
